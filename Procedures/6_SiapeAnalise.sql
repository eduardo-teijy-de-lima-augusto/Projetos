...
-- Ir� gerar duas tabelas uma de Clientes e outra de Contratos.
-- ===============================================================================================================================================================================
...
BEGIN
    ...
    BEGIN TRY
		...
		-- Altere a consulta caso seja necess�rio
		--============================================================================
        ...
        VALUES 
        (SUSER_SNAME(), 'Siape', @NomeTabela, 'Cria��o e Inser��o', CAST(@RowsAfetadas AS NVARCHAR(MAX)), @DescricaoLog, @TempoExecucao, REPLACE(@QuerySQL, '''', ''''''))
