...
# Tabela Campanhas2 AeroSetor e AeroBanco rotina mensal de atualização
---
## Essa documentação descreve o processo de atualização das tabelas AeroSetor e AeroBanco em CAMPANHAS2.
---
...
--INTO CAMPANHAS2..AeroSetor_NEW      --retire os traços do começo se for gerar nova tabela.
FROM CAMPANHAS2..AeroReceitasDespesas_NEW
GROUP BY UPAG, DESC_UPAG

```

>2. Tabela AeroBanco também é proveniente da tabela CAMPANHAS2..AeroReceitasDespesas onde: CAIXA=Banco, e algumas regras são aplicadas para esse filtro. Em conversa com a liderança ficou estipulado que não é para subir os caixas que tem FH em seu nome e POUPEX na tabela AeroBanco.
...
--INTO CAMPANHAS2..AeroBanco_NEW      --retire os traços do começo se for gerar nova tabela.
FROM CAMPANHAS2..AeroReceitasDespesas_New
